...
#define HUD_SPINNER_COLOR		[UIColor grayColor] //[UIColor colorWithRed:0.188 green:0.173 blue:0.173 alpha:1];
#define HUD_BACKGROUND_COLOR	[UIColor colorWithRed:0.984 green:0.984 blue:0.984 alpha:1]
