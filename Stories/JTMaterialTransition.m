...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext
{
    ...
    if(!self.isReverse){
        [UIView transitionWithView:animatedViewForTransition
                          duration:[self transitionDuration:transitionContext] * .5
                           options:0
                        animations:^{
        ...
        [UIView animateWithDuration:[self transitionDuration:transitionContext] * .64
                         animations:^{
                             presentedController.view.layer.opacity = 0;
                         } completion:nil];
        ...
        dispatch_after(dispatch_time(DISPATCH_TIME_NOW, NSEC_PER_SEC * [self transitionDuration:transitionContext] * .32), dispatch_get_main_queue(), ^{
            [UIView transitionWithView:animatedViewForTransition
                              duration:[self transitionDuration:transitionContext] * .6
                               options:0
                            animations:^{
